        ...
        <div id="light" class="white_content">
            ...
            <form class="form-horizontal col-xs-12 id" enctype="multipart/form-data" role="form">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="span11" id="name" value="<?php echo ($web["name"]); ?>"/>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right" for="form-field-1">ico : </label>
                    <div class="col-sm-9">
                        <div class="col-sm-3" id="preview_ico"><img height="100" src="/<?php echo ($web["ico"]); ?>"></div>
                        <div class="col-sm-6">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="col-sm-3" id="preview_logo"><img height="100" src="/<?php echo ($web["logo"]); ?>"></div>
                        <div class="col-sm-6">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        ...
                        <script type="text/javascript" width="560" height="465">
                            ...
                            ue.ready(function() {
                                ue.setContent('<?php echo ($web["content"]); ?>');
                            });
                        </script>
                    </div>
                </div>
...
<script>
        ...
        $.upload({
            ...
            onComplate: function(data) {
                if(data.indexOf('Image')>=0){
                    $("#ico").val(data);
                    $("#preview_ico").html('<img style="height:100px;" src="http://poofull.wvfeng.top//'+data+'"/>');
                }else{
                    alert(data);
                }
            }
    ...
    $('#upload_logo').click(function(){
        $.upload({
            ...
            onComplate: function(data) {
                if(data.indexOf('Image')>=0){
                    $("#logo").val(data);
                    $("#preview_logo").html('<img style="height:100px;" src="http://poofull.wvfeng.top//'+data+'"/>');
                }else{
                    alert(data);
                }
            }
        ...
        $.upload({
            ...
            onComplate: function(data) {
                if(data.indexOf('upload')>=0){
                    $("#img").val(data);
                    $("#preview").html('<img style="height:100px;" src="/Public/'+data+'"/>');
                }else{
                    alert(data);
                }
            }
    ...
    $("#save").click(function (e) {
        ...
        if (confirm('提交数据吗？')) {
            ...
            $.post("<?php echo U('Web/edit');?>",data, function (data) {
                alert(data);
                     location.reload();
