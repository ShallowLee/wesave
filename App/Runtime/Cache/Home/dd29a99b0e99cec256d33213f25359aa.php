...
<div class="widget-box">
    ...
    <div class="widget-content nopadding">
        <table class="table table-bordered data-table" style="font-size: 12px;">
            ...
            <tbody>
            <?php if(is_array($address)): $i = 0; $__LIST__ = $address;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$addresss): $mod = ($i % 2 );++$i;?><tr class="gradeX father">
                    <td><?php echo ($addresss["id"]); ?></td>
                    <td><img height="50px;" src="<?php echo ($addresss["wechat_pic"]); ?>"></td>
                    <td><?php echo ($addresss["wechat_name"]); ?> </td>
                    <td><?php echo ($addresss["wechat_id"]); ?> </td>

                    <td><?php echo ($addresss["name"]); ?></td>
                    <td><?php echo ($addresss["phone"]); ?></td>
                    <td><?php echo ($addresss["city"]); ?></td>
