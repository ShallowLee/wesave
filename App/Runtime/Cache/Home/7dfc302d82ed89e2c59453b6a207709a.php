        ...
        <div id="light" class="white_content">
            ...
            <form class="form-horizontal col-xs-12 id" enctype="multipart/form-data" role="form">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="span11" id="name" value="<?php echo ($product["name"]); ?>"/>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        ...
                        <div class="col-sm-4" id="preview"><img height="100" src="/<?php echo ($product["pic"]); ?>"></div>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right" for="form-field-1">视频URL : </label>
                    <div class="col-sm-9">
                        <input type="text" class="span11" id="video" value="<?php echo ($product["video"]); ?>"/>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <select id="product_classify_id">
                            <option value="<?php echo ($product_classify_one['id']); ?>" <?php if(($product["product_classify_id"]) == $product_classify_one['id']): ?>selected<?php endif; ?>><?php echo ($product_classify_one['name']); ?></option>
                            <?php if(is_array($product_classify)): $i = 0; $__LIST__ = $product_classify;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$product_classifys): $mod = ($i % 2 );++$i;?><option value="<?php echo ($product_classifys["id"]); ?>" <?php if(($product["product_classify_id"]) == $product_classifys["id"]): ?>selected<?php endif; ?>><?php echo ($product_classifys["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                        </select>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <select id="school">
                            <option value="1" <?php if(($product["status"]) == "1"): ?>selected<?php endif; ?>>上线状态</option>
                            <option value="0" <?php if(($product["status"]) == "0"): ?>selected<?php endif; ?>>下线状态</option>
                        </select>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="span11" id="price" value="<?php echo ($product["price"]); ?>"/>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right" for="form-field-1">商品单位 : </label>
                    <div class="col-sm-9">
                        <input type="text" class="span11" id="unit" value="<?php echo ($product["unit"]); ?>"/>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right" for="form-field-1">商品库存 : </label>
                    <div class="col-sm-9">
                        <input type="text" class="span11" id="num" value="<?php echo ($product["num"]); ?>"/>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right" for="form-field-1">商品描述 : </label>
                    <div class="col-sm-9">
                        <input type="text" class="span11" id="desc" value="<?php echo ($product["desc"]); ?>"/>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        ...
                        <script type="text/javascript" width="560" height="465">
                            ...
                            ue.ready(function() {
                                ue.setContent('<?php echo ($product["content"]); ?>');
                            });
                        </script>
                    </div>
                </div>
...
<script>
    ...
    $("#save").click(function (e) {
        ...
        if (confirm('提交数据吗？')) {
            ...
            $.post("<?php echo U('Product/product_edit');?>",data, function (data) {
                    if (data.code) {
                        alert(data.message);
