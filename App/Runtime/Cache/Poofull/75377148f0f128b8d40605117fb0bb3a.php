...
<br>
<?php if(is_array($address)): $i = 0; $__LIST__ = $address;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$addresss): $mod = ($i % 2 );++$i;?><div class="grey h90 lh30">
        <div  class="bl ml10b father">
            <input type="hidden" class="id" value="<?php echo ($addresss["id"]); ?>">
            <a href="/poofull/user/address_edit"><i class="icon-user "></i>   <span><?php echo ($addresss["name"]); ?></span><br>
            <i class="icon-phone-sign "></i>   <span><?php echo ($addresss["phone"]); ?></span> </a>
            <a href="/poofull/user/address_edit/id/<?php echo ($addresss["id"]); ?>" class="fr ft28 mr10 icon-edit "></a>
            <a href="/poofull/user/address_del" class="fr ft28 mr10 icon-trash "></a><br>
            <i class="icon-map-marker "></i>   <span><?php echo ($addresss["city"]); ?>   <?php echo ($addresss["address"]); ?></span>
        </div>
    </div>
