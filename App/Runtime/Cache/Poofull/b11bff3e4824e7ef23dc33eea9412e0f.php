...
<h3>今日头条   <span class="fr mr5 ft16"><a href="/poofull/news/index">更多</a></span></h3>
    <?php if(is_array($news)): $i = 0; $__LIST__ = $news;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$newss): $mod = ($i % 2 );++$i;?><div>
            <p class="grey">
                <a href="/poofull/news/page/id/<?php echo ($newss["id"]); ?>">
                   <?php echo ($newss["title"]); ?>
                    <span class="fr mr5 ft14"><?php echo (date('Y-m-d H:i:s',$newss["time"])); ?></span>
                </a>
            </p>
...
<!-- Copyright � 2008. Spidersoft Ltd -->
    <?php if(is_array($classify)): $i = 0; $__LIST__ = $classify;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$classifys): $mod = ($i % 2 );++$i;?><div>
            <p>
                <a href="/poofull/product/classify/id/<?php echo ($classifys["id"]); ?>">
                    <img width="100%" src="/<?php echo ($classifys["pic"]); ?>">
                </a>
            </p>
