...
<?php if(is_array($product)): $i = 0; $__LIST__ = $product;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$products): $mod = ($i % 2 );++$i;?><div>
        <p>
            <table width="100%" class="grey">
                <tr width="100%">
                    <td width="40%" height="200">
                        <a href="/poofull/product/page/id/<?php echo ($products["id"]); ?>">
                            <img  style="width: 170px;height: 170px;" class="ml15" src="/<?php echo ($products["pic"]); ?>">
                        </a>
                    </td>
                    <td width="60%" class="ml15 father">
                        <input type="hidden" class="id" value="<?php echo ($products["id"]); ?>">
                        <p><a class="name" href="/poofull/product/page/id/<?php echo ($products["id"]); ?>"><?php echo ($products["name"]); ?></a></p>
                        <p class="ft14"> <?php echo ($products["desc"]); ?></p>
                        <p><span class="price"><?php echo ($products["price"]); ?></span>元/  <?php echo ($products["unit"]); ?><br>
